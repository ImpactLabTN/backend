          ...
          <div className='container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center'>
            <div className='text-white space-y-6'>
              ...
              <p className='text-lg md:text-xl opacity-90'>
                A modern coworking space designed for professionals,
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                <Button
                  asChild
                  size='lg'
                  className='bg-secondary text-neutral-black hover:bg-secondary/90'
                >
                ...
                <Button
                  ...
                  size='lg'
                  variant='outline'
                  className='bg-white border-white text-primary hover:bg-white/10 hover:text-white'
                >
          ...
          <div className='container mx-auto px-4'>
            <div className='text-center mb-12'>
              <h2 className='text-3xl font-bold text-neutral-black mb-4'>
                Why Choose ImpactLab?
              </h2>
              <p className='text-neutral-grey max-w-2xl mx-auto'>
                We provide everything you need to work productively and build
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <p className='text-neutral-grey'>
                  Reliable, high-speed fiber internet to keep you connected and
                  productive.
                </p>
              </div>
              ...
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <p className='text-neutral-grey'>
                  Enjoy free coffee, tea, and filtered water throughout your
                  workday.
                </p>
              </div>
              ...
              <div className='bg-white p-6 rounded-lg shadow-sm'>
                ...
                <p className='text-neutral-grey'>
                  Book rooms by the hour, day, or month with our easy-to-use
                  reservation system.
                </p>
              </div>
            </div>
        ...
        <section className='py-16'>
          <div className='container mx-auto px-4'>
            <div className='text-center mb-12'>
              ...
              <p className='text-neutral-grey max-w-2xl mx-auto'>
                Discover the perfect workspace for your needs, from private
                offices to collaborative areas.
              </p>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-8'>
              <div className='rounded-lg overflow-hidden shadow-sm border'>
                ...
                <div className='p-6'>
                  ...
                  <p className='text-neutral-grey mb-4'>
                    Dedicated spaces for teams of 1-10 people with 24/7 access.
                  </p>
                  <Button
                    asChild
                    variant='outline'
              ...
              <div className='rounded-lg overflow-hidden shadow-sm border'>
                ...
                <div className='p-6'>
                  ...
                  <p className='text-neutral-grey mb-4'>
                    Professional spaces for client meetings, interviews, and
                    team sessions.
                  </p>
                  <Button
                    asChild
              ...
              <div className='rounded-lg overflow-hidden shadow-sm border'>
                ...
                <div className='p-6'>
                  ...
                  <p className='text-neutral-grey mb-4'>
                    Versatile areas for workshops, presentations, and networking
                    events.
                  </p>
                  <Button
                    asChild
        ...
        <section className='py-16 bg-primary text-white'>
          <div className='container mx-auto px-4 text-center'>
            ...
            <p className='text-lg mb-8 max-w-2xl mx-auto opacity-90'>
              Experience the perfect blend of productivity, flexibility, and
              community at ImpactLab.
            </p>
